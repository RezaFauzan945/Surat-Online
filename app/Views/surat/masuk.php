				...
				<div class="card">
					...
					<div class="card-content">
						...
						<div class="toolbar">
							...
							<a href="/surat/tambah_surat_masuk">
									...
									<?php foreach ($data as $key) : ?>
										<tr>
											...
											<td class="text-right">
												...
												<a href="/surat/edit_surat_masuk/<?= $key['id_surat_masuk']; ?>" class="btn btn-simple btn-primary btn-icon"><i class="material-icons">edit</i></a>
							...
							<div class="modal fade" id="hapusSuratMasuk<?= $key['id_surat_masuk']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
								<div class="modal-dialog modal-small ">
									<div class="modal-content">
										...
										<form method="post" action="/surat/hapusSuratMasuk/<?= $key['id_surat_masuk']; ?>">
											<?= csrf_field() ?>
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											<div class="instruction">
												<div class="row">
													<div class="col-md-12">
														<embed type="application/pdf" width="100%" height="450px;" src="/assets/uploads/surat/surat_masuk/<?= $key['file_surat_masuk'] ?>"></embed>
													</div>
