                                    ...
                                    <?php foreach ($data as $key) : ?>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href="/pegawai/edit/<?= $key['id_pegawai']; ?>" class="btn btn-simple btn-primary btn-icon"><i class="material-icons">edit</i></a>
                            ...
                            <div class="modal fade" id="hapusPegawai<?= $key['id_pegawai']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-small ">
                                    <div class="modal-content">
                                        ...
                                        <form method="post" action="/pegawai/hapus/<?= $key['id_pegawai']; ?>">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="instruction">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <img width="100%" height="450px;" src="/uploads/foto/<?= $key["foto"]?>">
                                                    </div>
