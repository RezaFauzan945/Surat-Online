                                    ...
                                    <?php foreach ($data as $key) : ?>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href="/user/edit/<?= $key['id_user']; ?>" class="btn btn-simple btn-primary btn-icon"><i class="material-icons">edit</i></a>
                                                ...
                                                <!-- <a href="user/hapus/<?= $key['id_user']; ?>" class="btn btn-simple btn-danger btn-icon"><i class="material-icons">close</i></a> -->
                                            </td>
                                        </tr>
                                        <?php $no++; ?>
                                    <?php endforeach; ?>
